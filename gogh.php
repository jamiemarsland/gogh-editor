...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_register_script( 'gogh-compose', plugins_url( 'gogh-compose.js', __FILE__ ), array(), '0.99.505-chrome', true );
	wp_enqueue_script( 'gogh-write', plugins_url( 'gogh-write.js', __FILE__ ), array( 'gogh-compose' ), '0.99.505-chrome', true );
	wp_enqueue_style( 'gogh-write', plugins_url( 'gogh-write.css', __FILE__ ), array(), '0.99.505-chrome' );
...
add_action( 'rest_api_init', function () {
	...
	register_rest_route( 'gogh/v1', '/version', array(
		...
		'callback'            => function () {
			return array( 'build' => '0.99.505-chrome' );
		},
	) );
...
add_action( 'admin_enqueue_scripts', function ( $hook ) {
	...
	wp_enqueue_script( 'gogh-admin', plugins_url( 'gogh-admin.js', __FILE__ ), array(), '0.99.505-chrome', true );
	wp_enqueue_style( 'gogh-admin', plugins_url( 'gogh-admin.css', __FILE__ ), array(), '0.99.505-chrome' );
 ...
 */
add_action( 'init', function () {
	// the looks someone kept from Remix: a shelf that survives the session
	register_setting( 'options', 'gogh_remix_kept', array(
		'type'         => 'array',
		'default'      => array(),
		'show_in_rest' => array(
			'schema' => array(
		...
		'sanitize_callback' => function ( $v ) {
			...
			foreach ( (array) $v as $k ) {
				if ( ! is_array( $k ) || empty( $k['colors'] ) ) {
					continue;
				}
				$c = array();
				foreach ( array( 'background', 'text', 'accent', 'accent2' ) as $role ) {
					if ( ! empty( $k['colors'][ $role ] ) && preg_match( '/^#[0-9a-fA-F]{6}$/', $k['colors'][ $role ] ) ) {
						$c[ $role ] = strtolower( $k['colors'][ $role ] );
					}
				}
				if ( empty( $c['background'] ) || empty( $c['text'] ) ) {
					continue;
				}
				$f = null;
				if ( ! empty( $k['fonts'] ) && is_array( $k['fonts'] ) ) {
					$f = array(
						'heading' => sanitize_key( $k['fonts']['heading'] ?? '' ),
						'body'    => sanitize_key( $k['fonts']['body'] ?? '' ),
					);
				}
				$out[] = array(
...
add_action( 'wp_enqueue_scripts', function () {
	wp_register_style( 'gogh-looks', false, array(), '0.99.505-chrome' );
...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_register_style( 'gogh-base', false, array(), '0.99.505-chrome' );
	...
	wp_register_script( 'gogh-view', false, array(), '0.99.505-chrome', true );
	...
	wp_register_script( 'gogh-compose', plugins_url( 'gogh-compose.js', __FILE__ ), array(), '0.99.505-chrome', true );
	wp_enqueue_script( 'gogh-editor', plugins_url( 'gogh-editor.js', __FILE__ ), array( 'gogh-compose' ), '0.99.505-chrome', true );
	wp_enqueue_style( 'gogh-editor', plugins_url( 'gogh-editor.css', __FILE__ ), array(), '0.99.505-chrome' );
	...
	if ( isset( $_GET['gogh-mcp'] ) || $gogh_exp || apply_filters( 'gogh_webmcp_enabled', false ) ) {
		wp_enqueue_script( 'gogh-webmcp', plugins_url( 'gogh-webmcp.js', __FILE__ ), array( 'gogh-editor' ), '0.99.505-chrome', true );
	}
	...
	if ( isset( $_GET['gogh-test'] ) ) {
		wp_enqueue_script( 'gogh-tests', plugins_url( 'gogh-tests.js', __FILE__ ), array( 'gogh-editor' ), '0.99.505-chrome', true );
	}
	...
	if ( isset( $_GET['gogh-walk'] ) ) {
		wp_enqueue_script( 'gogh-walk', plugins_url( 'gogh-walk.js', __FILE__ ), array( 'gogh-editor' ), '0.99.505-chrome', true );
	}
	...
	wp_localize_script( 'gogh-editor', 'GOGH', array(
		...
		'remixKept' => array_values( (array) get_option( 'gogh_remix_kept', array() ) ),
