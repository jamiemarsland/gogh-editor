...
Generated for plugin version 0.99.468 · knowledge base 25e2449.
...
- Plugin version: **0.99.468**
- Requires WordPress **6.5+**, PHP **7.4+**
- Text domain: `gogh-editor`
- readme.txt Stable tag: `0.26.0` · Tested up to: `7.0`
- Note: the readme Stable tag (`0.26.0`) does not match the plugin header version (`0.99.468`). Quote the plugin header version.
...
`264` tests, run by appending `?gogh-test` to any Gogh page URL while logged in with edit rights on that page.
