...
Generated for plugin version 0.99.507 · knowledge base 1c93580.
...
- Plugin version: **0.99.507**
- Requires WordPress **6.5+**, PHP **7.4+**
- Text domain: `gogh-editor`
- readme.txt Stable tag: `0.26.0` · Tested up to: `7.0`
- Note: the readme Stable tag (`0.26.0`) does not match the plugin header version (`0.99.507`). Quote the plugin header version.
...
`290` tests, run by appending `?gogh-test` to any Gogh page URL while logged in with edit rights on that page.
