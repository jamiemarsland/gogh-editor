...
check(bp.landingPage === '/?gogh-edit=1&gogh-build=1' && bp.steps[1].pluginData.url.endsWith('gogh-playground.zip') && bp.steps[2].code.includes(`/d/${pub.id}.json`) && bp.steps[2].code.includes('GOGH_SITE_DEF_JSON') && bp.steps[3].options.blogname === 'Bloom & Bough', 'the blueprint installs gogh and boots from the definition');
