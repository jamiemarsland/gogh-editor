# Knowledge-base audit — plugin v0.99.53
...
- plugin version is **0.99.53**, prose says **0.96.5**
...
- version: 0.99.43 → 0.99.53
- added UI label: "The gogh build this tab is running"
- added toast: "Kept — "
