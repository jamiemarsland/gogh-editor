# Knowledge-base audit — plugin v0.99.149
...
- plugin version is **0.99.149**, prose says **0.96.5**
...
- version: 0.99.148 → 0.99.149
- removed UI label: "Use a text title instead"
- added UI label: "Use a text name instead"
- added toast: "Could not save the name — try again."
- added toast: "Site name saved."
