# Knowledge-base audit — plugin v0.99.503
...
- version: 0.99.502 → 0.99.503
- removed UI label: "Keep the ' + l[1].toLowerCase() + ' you have; spin the rest"
- added UI label: "Keep the ' + l[2] + ' you have; spin the rest"
