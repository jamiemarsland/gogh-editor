# Knowledge-base audit — plugin v0.99.150
...
- plugin version is **0.99.150**, prose says **0.96.5**
...
- version: 0.99.149 → 0.99.150
- added UI label: "AG"
- added UI label: "Aa"
- added UI label: "As typed"
- added UI label: "UPPERCASE"
- added UI label: "ag"
- added UI label: "lowercase"
