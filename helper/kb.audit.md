# Knowledge-base audit — plugin v0.99.166
...
- plugin version is **0.99.166**, prose says **0.96.5**
...
- version: 0.99.165 → 0.99.166
- added UI label: "Site designs — swap the whole look"
