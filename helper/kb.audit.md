# Knowledge-base audit — plugin v0.99.84
...
- plugin version is **0.99.84**, prose says **0.96.5**
...
- version: 0.99.83 → 0.99.84
- added template: "Job card"
- added template: "Place card"
- added template: "Profile card"
